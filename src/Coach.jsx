...
import { loadTargets, loadMealsRange, loadBodyMetrics, addBodyMetric, todayKey } from "./data.js";
...
export default function Coach({ userId }) {
  ...
  async function cargarTodo() {
    setCargando(true);
    const [targets, meals, bodyMetrics, sets, runs] = await Promise.all([
      loadTargets(userId),
    ...
    setRecomendaciones(generarResumenSemana({ meals, targets, bodyMetrics, sets, ejercicios: EJERCICIOS, runs }));
    setCargando(false);
  }
